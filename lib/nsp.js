...
var ghOpts = {user: "nodesecurity", repo: "nodesecurity.io", path: "advisories"}
var rawUrl = "https://raw.githubusercontent.com/nodesecurity/nodesecurity.io/master/advisories"
...
function updateAdvisories (cb) {
  ...
  gh.repos.getContent(ghOpts, function (er, files) {
    ...
    if (!files) return cb(new Error("Advisories not found"))
