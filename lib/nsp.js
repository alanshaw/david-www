...
// by dependency name
function getAdvisories (depNames, cb) {
...
module.exports.syncAdvisories = syncAdvisories

var syncAdvisoriesIntervalId = null

function syncAdvisoriesPeriodically (interval) {
  clearInterval(syncAdvisoriesIntervalId)
  interval = interval || 3600000
  syncAdvisoriesIntervalId = setInterval(syncAdvisories, interval)
}

module.exports.syncAdvisoriesPeriodically = syncAdvisoriesPeriodically
